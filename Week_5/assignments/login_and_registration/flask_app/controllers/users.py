...
def register():
    ...
    session['first_name'] = request.form['first_name'] #used to display username in the dashboard page
...
def login():
    ...
    session['first_name'] = found_user.first_name #used to display username in the dashboard page
    return redirect('/dashboard')
