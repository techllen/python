...
# this method retrieves a recipe with its user
@app.route("/view_recipe_with_user/<int:id>")
def view_recipe_with_user(id):
    data = {
        "id" : id
    }
    # retrieving one recipe details
    recipe_details_to_display = recipe.Recipe.get_recipe_with_creator(data)
    return render_template("recipe_details.html",details = recipe_details_to_display)
