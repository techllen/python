...
def open_account():
    user_name_entered = str(input("Please enter your name: ")) 
    print(user_name_entered)
    account_type_choice = int(input("Choose Account type Select 1 for Checking account and 2 for Savings Account"))
    print(account_type_choice)
    
    if account_type_choice == 1:
        user1 = User(user_name_entered)
